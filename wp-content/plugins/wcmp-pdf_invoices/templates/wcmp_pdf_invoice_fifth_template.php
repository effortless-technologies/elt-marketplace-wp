...
?>
<div style="width:100%; margin:0px auto; font-family:Trebuchet MS, Arial, Helvetica, sans-serif; color:#555; line-height:24px; font-size:12px" class="alignCenter profLogo">
    ...
    <div style="width:100%; margin:0px auto; font-family:Trebuchet MS, Arial, Helvetica, sans-serif; color:#555; line-height:24px; font-size:12px" class="alignCenter profLogo">
        <table width="100%" border="0" cellspacing="0" cellpadding="10"  style="color:#666; line-height:26px; font-size:12px; margin:10px 0; padding:10px; border-bottom:1px double #ddd; ">
            <tbody>
                <tr>
                    <td align="left" valign="top" style="font-size:35px; color:#444; width:25%; padding-bottom:15px;">INVOICE</td>   
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="top">
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td align="left" valign="top">Name - </td><td align="left" valign="top"><?php echo $general_settings['company_name']; ?></td>
                                                </tr>  
                                                <tr>
                                                    <td  align="left" valign="top">Address -</td><td align="left" valign="top"><?php echo nl2br($general_settings['company_address']); ?></td>
                                                </tr>  
                                                <tr>
                                                    <td align="left" valign="top">Email -</td><td align="left" valign="top"><?php echo $general_settings['company_email']; ?></td>
                                                </tr>  
                                                <tr>
                                                    <td align="left" valign="top">Ph No. -</td><td align="left" valign="top"><?php echo $general_settings['company_ph_no']; ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
    ...
    <div style="background:#f8f8f8; padding:20px 3%; border-top:1px solid #222; border-bottom:1px solid #222; width:94%; color:#444; line-height:20px; font-size:18px; margin:0px 0 20px 0;">
        <?php
        if ($user_type == 'admin') {
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="10" style="margin-top: 300px;">
        <tbody>
            <tr>
                <td  style="color:#666; line-height:24px; font-size:14px; padding:30px 1%;width:30%;" >Order Number:</td>
                ...
                <td  style="color:#666; line-height:24px; font-size:14px; padding:30px 1%;width:30%;" >Order Date:</td>
                ...
                if ($user_type == 'admin') {
                    if (isset($general_settings['is_payment_method_admin']) && $general_settings['is_payment_method_admin'] == 'Enable') {
                        ?>
                        <td  style="color:#666; line-height:24px; font-size:14px; padding:30px 1%;width:30%;" >Payment Method:</td>
    ...
    <?php if ($user_type == 'vendor') { ?>
        <div style="padding:20px 1%; width:98%; line-height:24px; ">
            <div style="color:#777; font-size:18px;"> Special Note from Admin:</div>
            <?php
            if ($vendor_user_details) {
    ...
    <?php } else if (!empty($general_settings['spcl_notes_from_admin'])) { ?>
        <div style="padding:20px 1%; width:98%; line-height:24px; ">
            <h3 style="color:#777; font-size:22px;"> Special Note from Admin:</h3>
            <?php
            echo '<p style="color:#444; font-size:12px;">' . $general_settings['spcl_notes_from_admin'];
            ?>
        </div>
    ...
    <div style="color:#777; font-size:22px; padding-bottom:20px;"> Order Details</div> 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="10"  style="border:4px solid #bbb; color:#666; line-height:26px; font-size:12px;background-color: #f4f8ff;">
        <thead>
            <tr>
                <td scope="col" align="left" valign="top"><strong>Item</strong></td>
                <td scope="col" align="left" valign="top"><strong>SKU</strong></td>
                <td scope="col" align="left" valign="top"><strong>Quantity</strong></td>
                <td scope="col" align="left" valign="top"><strong>Cost</strong></td>
            </tr>
        </thead>
        <tbody>
            <?php
                    ...
                    <tr>
                        ...
                        if ($user_type == 'admin') {
                            if (isset($general_settings['is_sku_admin']) && $general_settings['is_sku_admin'] == 'Enable') {
                                ...
                                ?>
                                <td align="left" valign="top" style="border-bottom:1px solid #bbb;">NA</td><?php
                            }
                        } else if ($user_type == 'vendor') {
                            if ($vendor_user_details) {
                        ...
                        <td  align="left" valign="top" style="border-bottom:1px solid #bbb; font-family: DejaVu Sans;" ><?php echo $order->get_formatted_line_subtotal($item) ?></td>
                    </tr>
                    <?php
                }
            }
                ...
                foreach ($totals as $total_key => $total) {
                    ...
                    if (array_key_exists($total_key, $wcmp_pdf_setting_array)) {
                        if ($user_type == 'admin') {
                            if (isset($general_settings[$wcmp_pdf_setting_array[$total_key] . '_admin']) && $general_settings[$wcmp_pdf_setting_array[$total_key] . '_admin'] == 'Enable') {
                                ?><tr>
                                    ...
                                    <td align="left" valign="top" style="font-size:15px; font-family: DejaVu Sans;"><?php echo $total['value']; ?></td>
                                </tr><?php
                            }
                        } else if ($user_type == 'vendor') {
                            if ($vendor_user_details) {
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top" style="font-size:18px; font-family: DejaVu Sans; border-top:1px solid #bbb; color:#222;" > <?php echo $total['value']; ?></td>
                        </tr>
                    <?php } else { ?>
                        <tr>
                            <td colspan="3" align="left" valign="top" style="font-size:14px; "><?php echo $total['label']; ?></td>
        ...
        <tbody>
            <tr>
                <?php if ($user_type == 'admin') { ?>
                    <td align="left" valign="top" style="font-size:17px; color:#444; " ><strong>Risk of loss</strong></td>
            ...
            if ($user_type == 'admin') {
                if (isset($general_settings['is_customer_note_admin']) && $general_settings['is_customer_note_admin'] == 'Enable') {
                    ?>
                    <tr>
                        <td colspan="2" align="left" valign="top" style="font-size:17px; color:#777; " ><strong>Customer Note</strong></td>
                    </tr>
                    <tr>
