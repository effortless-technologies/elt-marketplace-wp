...
<div style="width:100%; margin:0px auto; font-family:Arial, Helvetica, sans-serif; color:#555;  font-size:16px" class="alignCenter profLogo">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3" style="color:#666; line-height:26px; font-size:16px; padding:0;">
                    <tbody>
                        <tr>
                            ...
                            <td align="right" valign="top" style="font-size:28px;"><p>INVOICE<br>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr>
                        <td style="width:50%" align="left" valign="top">
                            ...
                            <div style="font-size:20px; color:#09F; background:#f1f1f1; width:96%; padding:20px 2%; text-align:right; font-family: DejaVu Sans;">
                        ...
                        <td style="padding:0px 0 10px 0; ">
                            <table width="100%" border="0" cellspacing="0" cellpadding="10">
                                <tr>
                                    <td align="left" valign="top">
                                        <h3 style="color:#111; font-size:15px; font-weight:bold">Invoice To:</h3>
                                        <?php
                                    ...
                                    <td align="left" valign="top">
                                        <h3 style="color:#111; font-size:15px; font-weight:bold">Ship To:</h3>
                                        <?php
    ...
    <div style="width:100%; border-bottom:1px solid #ddd; border-top:1px solid #ddd;">
        <table width="100%" border="0" cellspacing="0" cellpadding="10">
            <tr>  
                <td align="left" style="color:#666; line-height:24px; font-size:14px; font-weight:bold; padding:30px 0;">Order Number: #<?php echo $order->get_order_number(); ?></td>
                <td align="justify" style="color:#666; line-height:24px; font-size:14px; font-weight:bold; padding:30px 0;">Order Date: <?php echo $order->get_date_created(); ?></td>
                <?php
                if ($user_type == 'admin') {
                    if (isset($general_settings['is_payment_method_admin']) && $general_settings['is_payment_method_admin'] == 'Enable') {
                        ?>
                        <td align="right" style="color:#666; line-height:24px; font-size:14px; font-weight:bold; padding:30px 0;">Payment Method: <?php echo $order->get_payment_method_title(); ?></td>
                        <?php
                    }
                } else if ($user_type == 'vendor') {
                    if ($vendor_user_details) {
        ...
        <?php if ($user_type == 'vendor') { ?>
            <div style="padding:0 1% 20px 1%; width:98%; line-height:24px; ">
                <p style="color:#222; font-size:18px;"> Special Note from Admin:</p>
                <?php
                if ($vendor_user_details) {
        ...
        <p style="color:#777; font-size:18px;"> Order Details</p> 
