...
<div style="width:100%; margin:0px auto; font-family:Arial, Helvetica, sans-serif; color:#555; line-height:24px; font-size:14px">
    <table width="100%" border="0" cellspacing="0" cellpadding="3" style="color:#666; line-height:26px;  margin:0 0 0px 0; padding:20px 4%;">
        <tr> 
          <!--<td align="left" valign="middle" style="font-size:40px; color:#444; width:25%;"></td> -->
            <td align="left" valign="top" style="font-size:30px;">INVOICE<br>
                <span style="font-size:14px;"><?php echo 'Issued on : ' . date("F j, Y, g:i a"); ?></span></td>
        </tr>
    </table>
    <table border="0" cellspacing="0" cellpadding="15"  style="margin:0; color:#666; line-height:24px; font-size:15px; width:100%; padding:5px 4%; background:#2aa8fc;">
        <tr>
            ...
            <td align="right" valign="top" style="color:#fff;" ><?php echo nl2br($general_settings['company_address']); ?> <br>
                <?php echo 'Email: ' . $general_settings['company_email']; ?><br><?php echo 'Ph No:' . $general_settings['company_ph_no']; ?></td>
        </tr>
    </table>
    <table width="100%" border="0" cellspacing="0" cellpadding="5" >
        <tr>
            ...
            <td style=""><div style="font-size:24px; color:#2aa8fc; padding:20px 0; text-align:right; font-family: DejaVu Sans;"> <?php echo 'Invoice total:' . $invoice_total; ?> </div></td>
        </tr>
        <tr>
            <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="10">
                    <tr>
                        <td align="left" valign="top"><h3 style="color:#111; font-size:15px; font-weight:bold">Invoice To:</h3>
                            <?php
                            ...
                            ?></td>
                        <td align="left" valign="top" ><h3 style="color:#111; font-size:15px; font-weight:bold">Ship To:</h3>
                            <?php
            ...
            <td align="left" valign="top" style=""><div style="color:#666; line-height:28px; font-size:18px;  padding:20px 0 0px 8%;"> Order Number: #<?php echo $order->get_order_number(); ?><br>
                ...
                <div style="padding:0 1% 0px 8%; width:91%; ">
                    ...
                    if ($user_type == 'vendor') {
                        if ($vendor_user_details) {
                            echo '<p style="color:#222; font-size:18px;"> Special Note from Admin:</p><p style="color:#888; font-size:14px;">' . $vendor_user_details['spcl_notes_from_vendor'] . '</p>';
                        } else {
                            echo '<p style="color:#222; font-size:18px;"> Special Note from Admin:</p><p style="color:#888; font-size:14px;">' . $general_settings['spcl_notes_from_admin'] . '</p>';
                        }
                    } else if (!empty($general_settings['spcl_note_from_admin'])) {
                        echo '<p style="color:#222; font-size:18px;"> Special Note from Admin:</p><p style="color:#888; font-size:14px;">' . $general_settings['spcl_note_from_admin'] . '</p>';
                    }
                    ?>
                </div></td>
        </tr>
    ...
    <table border="0" cellspacing="0" cellpadding="5" align="left" width="100%"  style=" color:#666; line-height:26px; font-size:14px;">
        <tr>
            <td style="color:#777; font-size:16px; "> Order Details</td>
        </tr>
        <tr>
            ...
            <td><table border="0" cellspacing="0" cellpadding="5"  width="100%"  style=" color:#666; line-height:26px; font-size:14px;">
                    ...
                    <tr>
                        <td><?php if ($user_type == 'admin') { ?>
                                <p style="color:#222; font-weight:bold;">Risk of loss <span style="color:#666; font-weight:normal;"><?php echo $general_settings['term_and_conditions_admin']; ?></span></p>
                                <?php
                            } else if ($user_type == 'vendor') {
                                if ($vendor_user_details) {
                                    ?>
                                    <p style="color:#222; font-weight:bold;">Risk of loss <span style="color:#666; font-weight:normal;"><?php echo $vendor_user_details['term_and_conditions_vendor']; ?></span></p>
                                <?php } else { ?>
                                    <p style="color:#222; font-weight:bold;">Risk of loss <span style="color:#666; font-weight:normal;"><?php echo $general_settings['term_and_conditions_vendor']; ?></span></p>
                                    <?php
                                }
                            } else {
                                ?>
                                <p style="color:#222; font-weight:bold;">Risk of loss <span style="color:#666; font-weight:normal;"><?php echo $general_settings['term_and_conditions_customer']; ?></span></p>
                                <?php
                            }
                            ?>
                            <?php
                            if ($user_type == 'admin') {
                                if (isset($general_settings['is_customer_note_admin']) && $general_settings['is_customer_note_admin'] == 'Enable') {
                                    ?>
                                    <p style="color:#222; font-weight:bold;">Customer Note<span style="color:#666; font-weight:normal;"><?php echo $order->get_customer_note(); ?></span></p>
                                    <?php
                                }
                            } else if ($user_type == 'vendor') {
                                if ($vendor_user_details) {
