 ...
 *
 * Override this template by copying it to yourtheme/wcmp-product-import-export-bundle/variation-product-file-upload-form.php
 *
 * @author 		dualcube
				...
				<tbody>
					<tr>
						...
						<td>
							...
							<input type="hidden" name="max_file_size" value="<?php echo $WCMp_Product_Import_Bundle->bytes; ?>" /><br/><br/>
