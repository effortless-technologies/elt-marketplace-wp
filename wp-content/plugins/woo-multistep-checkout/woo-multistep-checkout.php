 ...
 * Description: WooCommerce MultiStep Checkout Editor breaks up the usual WooCommerce checkout form into multiple steps for a friendlier user experience.
 * Version:     1.0.1
 * Author:      ThemeHigh
