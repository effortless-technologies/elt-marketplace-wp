				...
				<table>
					<tbody>
						<tr>
							...
							<td style="padding : 0 0 0 2px; "><p class="submit"><input type="submit" name="wcmp_product_submit" id="submit" class="button button-primary all_new_btn" value="<?php _e( 'Filter', 'wcmp-vendor_frontend_report' ); ?>"></p></td>
						</tr>
					</tbody>
				</table>
			</form>
		...
		<div class="sorting_box">
			<div class="product_report_sort_outer">
				<select name="product_report_sort" class="product_report_sort">
					<option value="total_sales"><?php _e( 'Total Sales', 'wcmp-vendor_frontend_report' ); ?></option>
					<option value="admin_earning"><?php _e( 'My Earnings', 'wcmp-vendor_frontend_report' ); ?></option>
				</select>
			</div>
