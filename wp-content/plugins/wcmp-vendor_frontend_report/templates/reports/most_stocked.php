...
<div>
	<?php if($show_more_button) { ?>
		<input type="button" class="all_new_btn" style="float: right;" id="more_most_stocked" data-show="<?php echo $current_page;?>" value="<?php _e( 'More Products', 'wcmp-vendor_frontend_report' ); ?>"/>
	<?php } ?>
