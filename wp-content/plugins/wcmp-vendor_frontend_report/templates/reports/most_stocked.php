...
<table class="most_stocked_report">
	<thead>
		<tr>
...
<div>
	<?php if($show_more_button) { ?>
		<input type="button" class="all_new_btn" style="float: right;" id="more_most_stocked" data-show="<?php echo $current_page;?>" value="<?php _e( 'More Products', $WCMp_Vendor_Frontend_Report->text_domain ); ?>"/>
	<?php } ?>
