 ...
 *
 */
class WCMp_Vendor_Frontend_Report_Dependencies {
	...
	static function wcmp_vendor_stock_alert_plugin_active_check() {
		if ( ! self::$active_plugins ) self::init();
		return in_array( 'wcmp-vendor_stock_alert/wcmp_vendor_stock_alert.php', self::$active_plugins ) || array_key_exists( 'wcmp-vendor_stock_alert/wcmp_vendor_stock_alert.php', self::$active_plugins );
		return false;
	}
}