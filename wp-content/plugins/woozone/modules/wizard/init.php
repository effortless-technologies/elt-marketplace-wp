    ...
    class WooZoneWizard
    {
        ...
        */
        ...
        public function setupAmazonWS( $params=array() ) {
			...
			$WooZone->build_amz_settings($settings_new);
			$this->the_plugin = $WooZone;
            ...
            */
            ...
            if (1) {
				...
				if ( class_exists('WooZoneAmazonHelper') ) {
					//$this->amzHelper = WooZoneAmazonHelper::getInstance( $this->the_plugin );
					$this->amzHelper = new WooZoneAmazonHelper( $this->the_plugin ); //$this->the_plugin | $WooZone
				}
			}
            $params_new = array(
