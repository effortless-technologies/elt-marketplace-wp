...
WooZoneSpeedOptimization = (function ($) {
    ...
    function take_over_ajax_loader_close(elm = false, callback)
    {
    	if( elm.length > 0 ) {
    ...
    function take_over_confirm( label, notice=false )
    {
	...
	function update_all_scores( product_id, where=null, callback )
    {
    	//take_over_ajax_loader( speed_optimization_msg.loading );
