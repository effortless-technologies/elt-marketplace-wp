...
if(class_exists('WooZone') != true) {
	class WooZone {
		...
		// March 2016 - new /Update on 2017-10-03
		public $demo_keys = array(
			...
			'pairs' 		=> array(
				...
				array('AKIAIZZOWEZECDGXRXAA', 'qA0eD0yhQdRyiENivzsDc423xphoFxbm/bx+y8MV'),
				//:: end - DO NOT EDIT

				// add new pairs from here..
				//array('AKIAIKFIR7QHU3RJIYWQ', 'yMj6J+/ZjzB7YnHWDHRsZsi0wHFc/jD696/'),
				//array('AKIAJYSQRYKT7574QQRA', '+K1AiA+e4cmXfFc+e53DnkWNx2xqI'),
			),
		);
		...
		?>
			...
			<script type="text/javascript">
				jQuery(document).ready(function ($) {
					...
					// Fix Flatsome theme
					<?php if( strpos(wp_get_theme(), 'Flatsome') !== false ) { ?>
						var $prod_container = $('div.product .product-main');
					<?php }else{ ?>
