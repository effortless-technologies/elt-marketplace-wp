...
if (!class_exists('WCMp_FPM_WP_Fields')) {
    ...
    class WCMp_FPM_WP_Fields {
        ...
        <span class="dc-wp-fields-uploader">
          ...
          <input type="button" class="upload_button button button-secondary" name="%s_button" id="%s_button" data-mime="%s" value="' . __( 'Upload', 'wcmp-frontend_product_manager' ) . '" />
          <input type="button" class="remove_button button button-secondary" name="%s_remove_button" id="%s_remove_button" data-mime="%s" value="' . __( 'Remove', 'wcmp-frontend_product_manager' ) . '" />
        </span>
