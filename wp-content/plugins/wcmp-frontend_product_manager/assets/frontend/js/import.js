			...
			success: function( response ) {
				if ( response.success ) {
					...
					if ( 'done' === response.data.position ) {
						...
						//console.log(',,,a,');
						//console.log(location.protocol + '//' + location.host + location.pathname+'?step='+$.urlParam('step')+'&nonce='+$.urlParam('nonce')+ '&products-imported=' + parseInt( $this.imported, 10 ) + '&products-failed=' + parseInt( $this.failed, 10 ) + '&products-updated=' + parseInt( $this.updated, 10 ) + '&products-skipped=' + parseInt( $this.skipped, 10 ));
						window.location = location.protocol + '//' + location.host + location.pathname+'?step='+$.urlParam('step')+'&nonce='+$.urlParam('nonce')+ '&products-imported=' + parseInt( $this.imported, 10 ) + '&products-failed=' + parseInt( $this.failed, 10 ) + '&products-updated=' + parseInt( $this.updated, 10 ) + '&products-skipped=' + parseInt( $this.skipped, 10 );
					} else {
						$this.run_import();
					}
				}
