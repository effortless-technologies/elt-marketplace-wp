 ...
 *
 * Override this template by copying it to yourtheme/wcmp-vendor_stock_alert/emails/vendor_out_of_stock_alert_email.php
 *
...
<p><?php printf( __( "Hi there. A Product is out of stock. Product details are shown below for your reference:", 'wcmp-vendor_stock_alert' ) );
