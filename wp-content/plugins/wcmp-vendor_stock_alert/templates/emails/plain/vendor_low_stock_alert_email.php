 ...
 *
 * Override this template by copying it to yourtheme/wcmp-vendor_stock_alert/emails/plain/vendor_low_stock_alert_email.php
 *
...
echo sprintf( __( "Hi there. A Product is low in stock. Product details are shown below for your reference:", 'wcmp-vendor_stock_alert' ) ) . "\n\n";
