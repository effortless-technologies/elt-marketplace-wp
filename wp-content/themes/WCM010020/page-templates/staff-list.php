            ...
            <div class="entry-content">
              ...
              <div class="staff-right">
                ...
                <div class="staff-social">
                  ...
                  <a href="<?php echo esc_url($staff_link); ?>" title="<?php echo __('Website', 'templatemela');?>" class="website icon"><i class="fa fa-link"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_email)) :  ?>
                  <a href="<?php echo esc_url($staff_email); ?>" title="<?php echo __('Email', 'templatemela');?>" class="email icon"><i class="fa fa-envelope-o"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_twitter)) :  ?>
                  <a href="<?php echo esc_url($staff_twitter); ?>" title="<?php echo __('Twitter', 'templatemela');?>" class="twitter icon"><i class="fa fa-twitter"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_facebook)) :  ?>
                  <a href="<?php echo esc_url($staff_facebook); ?>" title="<?php echo __('Facebook', 'templatemela');?>" class="facebook icon"><i class="fa fa-facebook"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_google_plus)) :  ?>
                  <a href="<?php echo esc_url($staff_google_plus); ?>" title="<?php echo __('Google Plus', 'templatemela');?>" class="google-plus icon"><i class="fa fa-google-plus"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_linkedin)) :  ?>
                  <a href="<?php echo esc_url($staff_linkedin); ?>" title="<?php echo __('Linkedin', 'templatemela');?>" class="linkedin icon"><i class="fa fa-linkedin"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_youtube)) :  ?>
                  <a href="<?php echo esc_url($staff_youtube); ?>" title="<?php echo __('Youtube', 'templatemela');?>" class="youtube icon"><i class="fa fa-youtube"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_rss)) :  ?>
                  <a href="<?php echo esc_url($staff_rss); ?>" title="<?php echo __('RSS', 'templatemela');?>" class="rss icon"><i class="fa fa-rss"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_pinterest)) :  ?>
                  <a href="<?php echo esc_url($staff_pinterest); ?>" title="<?php echo __('Pinterest', 'templatemela');?>" class="pinterest icon"><i class="fa fa-pinterest"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_skype)) :  ?>
                  <a href="<?php echo esc_url($staff_skype); ?>" title="<?php echo __('Skype', 'templatemela');?>" class="skype icon"><i class="fa fa-skype"></i></a>
                  <?php endif; ?>
                </div>
              </div>
            </div>
