...
<style type="text/css">
	...
	.site-header{
		background-color:#<?php echo esc_attr(get_option('tmoption_headerbkg_color')) ; ?> ;
	}
	...
	body {
		...
		<?php /*?>background-image: url("<?php echo get_template_directory_uri(); ?>/images/megnor/colorpicker/pattern/<?php echo get_option('tmoption_texture'); ?>");
		...
		background-attachment:<?php echo get_option('tmoption_back_attachment'); ?>;<?php */?>
		<?php } else { ?>
		background-image: url("<?php echo esc_url(get_option('tmoption_background_upload')); ?>");
	...
	.topbar-main { color:#<?php echo esc_attr(get_option('tmoption_topbar_text_color')); ?>;background-color:#<?php echo esc_attr(get_option('tmoption_menubg_color')) ; ?> ; }
	.topbar-main a, .header-menu-links li a, .header_login a{ color:#<?php echo esc_attr(get_option('tmoption_topbar_link_color')); ?>; }
	.topbar-main a:hover, .header-menu-links li a:hover, .header_login a:hover{ color:#<?php echo esc_attr(get_option('tmoption_topbar_link_hover_color')); ?>; }
	.site-header {
